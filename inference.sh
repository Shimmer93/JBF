...
bash tools/dist_run.sh tools/inference.py 8 \
    ...
    --jbf-config SNSNet/configs/body_2d_keypoint/jbf/td-hm_hrnet-w32_8xb64-210e_inference-256x256.py \
    ...
    --har-config JBFConv3D/configs/jbf/slowonly_r50_8xb16-u48-240e_ntu120-xsub-keypoint_inference.py \
    ...
    --out-jbf-dir inference/demo/jbfs \
    --out-anno-dir inference/demo/annos \
    --out-result-dir inference/demo/results \
