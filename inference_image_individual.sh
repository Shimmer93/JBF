...
bash tools/dist_run.sh tools/inference.py 8 \
    ...
    --jbf-config SNSNet/configs/body_2d_keypoint/jbf/td-hm_hrnet-w32_8xb64-210e_inference_imagebox-256x256.py \
    ...
    --har-config JBFConv3D/configs/jbf/slowonly_r50_8xb16-u48-240e_ntu120-xsub-keypoint_inference_imagebox.py \
    ...
    --out-jbf-dir inference/demo_image_individual/jbfs \
    --out-anno-dir inference/demo_image_individual/annos \
    --out-result-dir inference/demo_image_individual/results \
